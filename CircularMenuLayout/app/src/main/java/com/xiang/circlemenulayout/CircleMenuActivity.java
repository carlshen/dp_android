...
public class CircleMenuActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCirleMenuLayout = (CirleMenuLayout) findViewById(R.id.id_circle_menu_layout);
        ...
        mCirleMenuLayout.setOnItemClickListener(new CirleMenuLayout.OnMenuItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                Toast.makeText(CircleMenuActivity.this, mItemTexts[position], Toast.LENGTH_LONG).show();
            }

            @Override
            public void onCenterItemClick(View view) {
                Toast.makeText(CircleMenuActivity.this, "中间菜单", Toast.LENGTH_LONG).show();
            }
        });
